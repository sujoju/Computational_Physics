...
for t in ${tsteps[*]}; do
    ...
    ./bin/midterm_1.exe $xmax $t 0 > ./data/decay_euler_tstep_${t}_opt.dat
    ./bin/midterm_1.exe $xmax $t 1  > ./data/decay_rkO2_tstep_${t}_opt.dat
    ./bin/midterm_1.exe $xmax $t 2  > ./data/decay_rkO4_tstep_${t}_opt.dat
done 
