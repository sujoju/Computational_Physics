...
set output "img/midterm_2_fft_sum.png"
...
p "data/fft_beat_sum.dat" u ($2/(N*0.000033)):(sqrt($8*$8)) w l title title_re_k3, "data/fft_beat_sum.dat" u ($2/(N*0.000033)):(sqrt($10*$10)) w l title title_im_k3
